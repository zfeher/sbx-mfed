 ...
 * @property {string | function(PathData, AssetInfo=)} filenameTemplate
...
class Template {
  ...
  static renderChunkModules(renderContext, modules, renderModule, prefix = '') {
    ...
    /** @type {{id|number, source: Source|string}[]} */
    ...
    if (bounds) {
      ...
      source.add('[\n');
      /** @type {Map<string|number, {id|number, source: Source|string}>} */
...
exports.NUMBER_OF_IDENTIFIER_START_CHARS = NUMBER_OF_IDENTIFIER_START_CHARS;
