...
const { RuntimeGlobals, Compilation } = require('webpack');
const { Template } = require('../JsonpChunkLoadingRuntimeModule/Template');
const {
  InvertedContainerRuntimeModule,
} = require('./InvertedContainerRuntimeModule');
const {
  RemoveEagerModulesFromRuntimePlugin,
} = require('./RemoveEagerModulesFromRuntimePlugin');
...
exports.InvertedContainerPlugin = InvertedContainerPlugin;
